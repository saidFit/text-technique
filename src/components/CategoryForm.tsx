...
const CategoryForm: React.FunctionComponent<ICategoryFormProps> = (props) => {
    ...
    const [errorAlert,setErrorAlter] = React.useState<string>('');
        ...
        <form onSubmit={(e) => handleSumbit(e)} className='w-full max-w-[400px] my-24 border border-gray-400 pb-8 shadow-MyBox1 rounded-md px-12 mx-auto'>
          ...
          <article className="space-y-3 flex flex-col">
            <div className="flex flex-col space-y-2">
              <label>
                category Name <span className=" text-red-500 text-xl">*</span>
              </label>
              <input
                className={`${
                 errors?.includes("categoryName") ? "border border-rose-500" : ""
